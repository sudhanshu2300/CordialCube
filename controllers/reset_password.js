...
module.exports.render_email_page = async(req, res) => {
    ...
    return res.render('forgot_password_enter_mail', { title: 'CordialCube' });
}
...
module.exports.redirect_to_change_password_page = async function(req, res) {
        ...
        try {
            ...
            return res.render('change_pass', { title: 'CordialCube | Change Password', access_token: token_in_link });
        } catch (error) {
            if (error) {
